...
// }
  ...
  printf('Ciphertext: %s (length %d)%s', $cyphertext, strlen($cyphertext), PHP_EOL);
  printf('Deciphered text: %s (length %d)%s', $deciphered, strlen($deciphered), PHP_EOL);

  $query="update login set plaintext='".$user_name."'  , cyphertext='" .$cyphertext."' , decyphertext='".$deciphered."'  where username='" . $invisible . "';";
